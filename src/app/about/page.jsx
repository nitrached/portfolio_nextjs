      ...
      <div className="h-full overflow-scroll lg:flex overflow-x-hidden" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              Je m'appelle Manech Dubreil, je suis étudiant a Epitech. Je m'intéresse a plein de chose et plus particulièrement en ce moment au web et au c.
            </p>
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    Etudiant à Bréquigny
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    spécialité science de l'ingénieur et mathématique{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2021 - 2023{" "}
